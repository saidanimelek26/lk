...
// Block device descriptor - from old file
typedef struct {
    int dev;
    unsigned long blksz;
    unsigned long lba;
...
// Partition device - from old file
typedef struct {
    int id;
    int init;
...
// Address translation structures - from old file
typedef struct {
    u32 id;
    u64 len;
} addr_trans_info_t;
...
// ============================================================
// mmc_legacy_init (from old file - adapted)
// ============================================================
...
// ============================================================
// THE REST OF THE ORIGINAL CODE (from new file)
// ============================================================
