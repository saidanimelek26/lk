...
// ============================================================
// FIX: Changed BYTE_ORDER to lcd_byte_order to avoid conflict
// with endian.h which defines BYTE_ORDER as a macro
// ============================================================

typedef struct
{
    unsigned RGB_ORDER        : 1;
    unsigned lcd_byte_order   : 1;   // FIXED: was BYTE_ORDER
    unsigned PADDING          : 1;
    unsigned DATA_FMT         : 3;
    unsigned IF_FMT           : 2;
    unsigned COMMAND          : 5;
...
typedef struct
{
    ...
    LCD_REG_WROI_CON        WROI_CONTROL;       // C060   ← Uses fixed lcd_byte_order
